...
import styles from "./UpdateBreed.module.css"
import { Link, useNavigate, useNavigation, useParams } from "react-router-dom"
import { updateBreed } from "../../Redux/Actions/updateBreed";
    ...
    return (
        <div className={styles.divPrincipal}>
            ...
            <div className={styles.divUpdate}>
                <Link className={styles.link} to= {`/detail/${id}`}><button className={styles.btn}>Back</button></Link>
                <h1>Update Breed</h1>
                <div>
